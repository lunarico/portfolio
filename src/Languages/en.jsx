export default {
    ...
    visit:"Visit",
    projectDescriptionFly: "Website developed and designed for a company that offers Real Estate and tourism services at the same time. Builder with Html, Css and Javascript.",
    projectDescriptionKat: "Website developed as a Final Project presentation for the React.Js course. It is an E-commerce for a fictitious store dedicated to the sale of bijouteri. Builder with React.Js, Sass and Firebase for the database.",
    ...
    projectDescriptionAv: "This App was designed as a Final Project presentation for the UX/UI Design course. It is an App that connects independent professionals of different services with their clients to organize schedules in real time.",
